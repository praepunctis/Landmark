...
function push_landmark(latitude, longitude, name, description, image, n_ratings, rating, type) {
  Landmark.sync({
      force: false
  })
  .then(function () {
...
push_landmark(3.0,3.0,"patagonia","clothing dude", null, 30, 4.5, 1, null);
// console.log(pull_landmarks());